    ...
    <div class="addStudent">
        <p class="topNav">
            <el-breadcrumb separator-class="el-icon-arrow-right">
                ...
                <el-breadcrumb-item class="active">教师新增</el-breadcrumb-item>
            </el-breadcrumb>
        </p>
      ...
      <span :class="{'selected':tab===3}" @click="checkTab(3)">
        ...
        >
            <dl class="model essential" v-show="tab === 1">
                <dt>基本信息</dt>
                <el-form-item label="头像" prop="name" v-loading="isUpload">
                    <el-upload
                        class="avatar-uploader"
                        action='http://oss/upload'
...
export default {
    ...
    data() {
        return {
            tab: 1,
            tid: '',
            // http://minecraft-oss.s3.cn-north-1.jcloudcs.com/2019/03/27/8ff0201878cae10330fea9fc2ca62862.jpg
            ruleForm: {
                userName: "", //用户名
                nickName: "", //昵称
                password: "", //用户密码
        ...
        async beforeAvatarUpload(file) {
            ...
            try {
                ...
                if (status == 200 && result) {
                    this.isUpload = false;
                    this.ruleForm.imageUrl = result.url;
                }
            } catch (e) {
                console.log(e);
            }
